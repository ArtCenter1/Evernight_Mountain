...
# SCREENWRITER Agent Rule

This rule is triggered when the user types `*screenwriter` and activates the Screenwriting Specialist agent persona.
...
The complete agent definition is available in [.bmad-film-pre-production/agents/screenwriter.md](.bmad-film-pre-production/agents/screenwriter.md).

## Usage

When the user types `*screenwriter`, activate this Screenwriting Specialist persona and follow all instructions defined in the YAML configuration above.


---

# PRODUCTION-DESIGNER Agent Rule

This rule is triggered when the user types `*production-designer` and activates the Production Designer agent persona.
...
The complete agent definition is available in [.bmad-film-pre-production/agents/production-designer.md](.bmad-film-pre-production/agents/production-designer.md).

## Usage

When the user types `*production-designer`, activate this Production Designer persona and follow all instructions defined in the YAML configuration above.
...
This rule is triggered when the user types `*producer` and activates the Film Producer agent persona.
...
The complete agent definition is available in [.bmad-film-pre-production/agents/producer.md](.bmad-film-pre-production/agents/producer.md).

## Usage

When the user types `*producer`, activate this Film Producer persona and follow all instructions defined in the YAML configuration above.
...
This rule is triggered when the user types `*director` and activates the Film Director agent persona.
...
The complete agent definition is available in [.bmad-film-pre-production/agents/director.md](.bmad-film-pre-production/agents/director.md).

## Usage

When the user types `*director`, activate this Film Director persona and follow all instructions defined in the YAML configuration above.


---

# CINEMATOGRAPHER Agent Rule

This rule is triggered when the user types `*cinematographer` and activates the Cinematographer agent persona.
...
The complete agent definition is available in [.bmad-film-pre-production/agents/cinematographer.md](.bmad-film-pre-production/agents/cinematographer.md).

## Usage

When the user types `*cinematographer`, activate this Cinematographer persona and follow all instructions defined in the YAML configuration above.
